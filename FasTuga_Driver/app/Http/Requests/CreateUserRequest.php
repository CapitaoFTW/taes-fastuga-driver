...
class CreateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'license_plate' => ['required', Rule::unique('users', 'license_plate')->ignore($this->id), 'regex:/(^[A-Za-z]{2}-[0-9]{2}-[A-Za-z]{2}$)|^([0-9]{2}-[A-Za-z]{2}-[0-9]{2}$)|(^[0-9]{2}-[0-9]{2}-[A-Za-z]{2}$)|(^[A-Za-z]{2}-[0-9]{2}-[0-9]{2}$)|(^[A-Za-z]{2}[0-9]{2}[A-Za-z]{2}$)|(^[0-9]{2}[A-Za-z]{2}[0-9]{2}$)|(^[0-9]{2}[0-9]{2}[A-Za-z]{2}$)|(^[A-Za-z]{2}[0-9]{2}[0-9]{2}$)/'],
